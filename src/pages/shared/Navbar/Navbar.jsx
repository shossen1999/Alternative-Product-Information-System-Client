        ...
        <div className="navbar bg-base-100 relative z-[10]">
            ...
            <div className="navbar-start">
                    ...
                    {menuOpen && (
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            <li onClick={handleRouteClick}><NavLink
                                ...
                                to={`/myQueries/${user?.email}`}>My Queries</NavLink></li>
                            <li onClick={handleRouteClick}><NavLink
                                className={({ isActive }) =>
                                    isActive ? 'text-[#23BE0A] font-semibold text-[18px]' : 'font-semibold text-[18px] '
                                }
                                to={`/myRecommendations/${user?.email}`}>My Recommendation</NavLink></li>
                            <li onClick={handleRouteClick}><NavLink
                                className={({ isActive }) =>
                                    isActive ? 'text-[#23BE0A] font-semibold text-[18px]' : 'font-semibold text-[18px] '
                                }
                                to={`/recommendationsForMe/${user?.email}`}> Recommendations For Me</NavLink></li>
                ...
                <Link to='/' className="btn btn-ghost font-bold normal-case text-3xl">
                    ...
                    {/* <span style={{ color: theme === "dark" ? colors.journey : lightModeColors.journey }}>Lap</span>
                    <span style={{ color: theme === "dark" ? colors.junction : lightModeColors.junction }}>Guru</span> */}
                </Link>
            </div>
